...
import { FiUsers, FiUserCheck, FiShoppingBag, FiSettings } from "react-icons/fi"
...
const DashboardCard: React.FC<DashboardCardProps> = ({ icon, title, value, description, link }) => {
  const content = (
      ...
      <div className="p-6">
        <div className="flex items-center">
          ...
          <div>
            ...
            {value && <p className="mt-1 text-2xl font-bold text-indigo-600">{value}</p>}
