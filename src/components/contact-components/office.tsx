...
const Office = () => {
  const cards = [
    ...
    },
    {
      ...
      title1: "info@outfitplus.com", // Updated Email for your website
      title2: "support@outfitplus.com", // Updated Email for your website
